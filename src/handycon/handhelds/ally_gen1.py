...
async def process_event(seed_event, active_keys):
    ...
    if active_keys == [29, 56, 111] and button_on == 1 and button4 not in handycon.event_queue:
        handycon.event_queue.append(button4)
        await handycon.do_rumble(0, 150, 1000, 0)
    elif active_keys == [] and seed_event.code in [29, 56, 111] and button_on == 0 and button4 in handycon.event_queue:
        this_button = button4
    ...
    elif active_keys == [] and seed_event.code in [184] and button_on == 0 and button8 in handycon.event_queue:
    ...
    elif active_keys == [] and seed_event.code in [185] and button_on == 0 and button9 in handycon.event_queue:
