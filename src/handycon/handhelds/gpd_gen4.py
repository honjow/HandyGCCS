...
def init_handheld(handheld_controller):
    ...
    handycon.GAMEPAD_ADDRESS = 'usb-0000:63:00.3-5/input0'
    handycon.GAMEPAD_NAME = 'Microsoft X-Box 360 pad'
    handycon.KEYBOARD_ADDRESS = 'usb-0000:63:00.3-3/input1'
...
async def process_event(seed_event, active_keys):
    ...
    # BUTTON 2 (Default: QAM)  KEY_LEFTCTRL + KEY_KPSLASH
    if active_keys == [29, 98] and button_on == 1 and button2 not in handycon.event_queue:
        await handycon.handle_key_down(seed_event, button2)
    elif active_keys == [] and seed_event.code in [29, 98] and button_on == 0 and button2 in handycon.event_queue:
