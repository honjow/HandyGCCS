...
EVENT_KILL = [[e.EV_KEY, e.KEY_LEFTMETA], [
    e.EV_KEY, e.KEY_LEFTCTRL], [e.EV_KEY, e.KEY_ESC]]
EVENT_MODE = [[e.EV_KEY, e.BTN_MODE]]
EVENT_OPEN_CHIM = ["Open Chimera"]
EVENT_SPECIAL_SUSPEND = ["Special Suspend"]
EVENT_OSK = [[e.EV_KEY, e.BTN_MODE], [e.EV_KEY, e.BTN_WEST]]
EVENT_OSK_DE = [[e.EV_KEY, e.KEY_LEFTMETA], [
    e.EV_KEY, e.KEY_LEFTCTRL], [e.EV_KEY, e.KEY_O]]
...
EVENT_VOLUP = [[e.EV_KEY, e.KEY_VOLUMEUP]]
EVENT_VOLDOWN = [[e.EV_KEY, e.KEY_VOLUMEDOWN]]
EVENT_MAP = {
    ...
    "SPECIAL_SUSPEND": EVENT_SPECIAL_SUSPEND,
    "VOLUP": EVENT_VOLUP,
...
INSTANT_EVENTS = [EVENT_MODE, EVENT_OPEN_CHIM, EVENT_TOGGLE_GYRO,
                  EVENT_TOGGLE_MOUSE, EVENT_TOGGLE_PERF, EVENT_SPECIAL_SUSPEND, EVENT_VOLUP, EVENT_VOLDOWN]
QUEUED_EVENTS = [EVENT_ALT_TAB, EVENT_ESC, EVENT_KILL, EVENT_OSK,
                 EVENT_OSK_DE, EVENT_OSK_NES, EVENT_QAM, EVENT_QAM_NES, EVENT_SCR]
FF_DELAY = 0.2
